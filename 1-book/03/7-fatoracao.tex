...
\begin{example}
  ...
  \[
    \begin{array}{r|l}
        x^3 - 9x^2            + 26x - 24 \; & \; x-2         \\ \cline{2-2}
      -(x^3 - 2x^2) \hphantom{{}+ 26x - 24} & \; x^2 -7x +12 \\ \cline{1-1}
                                            & \\[\dimexpr-\normalbaselineskip+\jot]
            - 7x^2 + 26x            - 24 \; &  \\
          -(- 7x^2 + 14x) \hphantom{{}- 24} &  \\ \cline{1-1}
                                            &  \\[\dimexpr-\normalbaselineskip+\jot]
                                12x - 24 \; &  \\
                              -(12x - 24)   &  \\ \cline{1-1}
                                       0 \; &
...
\begin{example}
  ...
  \begin{align*}
    \frac{2x-6}{x-3}
    & = \frac{2(x-3)}{x-3} \\
    & = \frac{2\cancel{(x-3)}}{\cancel{x-3}} &\text{usando que } x \neq 3 \\
    & = 2.
  \end{align*}
...
\begin{example}
  ...
  \begin{align*}
    ...
    & = \frac{\cancel{x^2}(1+x^2)}{3\cancel{x^2} x} & \text{usando que } x \neq 0 \\
    & = \frac{1+x^2}{3x}.
  \end{align*}
\end{example}
%------------------------------------------------------------------------------%
...
\begin{example}
  ...
  \begin{align*}
    \frac{x^2-9}{x^2-3x}
    & = \frac{(x-3)(x+3)}{x(x-3)} \\
    & = \frac{\cancel{(x-3)}(x+3)}{x\cancel{(x-3)}} & \text{usando que } x \neq 3 \\
    & = \frac{x+3}{x}.
  \end{align*}
...
\begin{example}
  ...
  \begin{align*}
    \frac{x^2-5x+4}{x-4}
    & = \frac{(x-4)(x-1)}{x-4}  \\
    & = \frac{\cancel{(x-4)}(x-1)}{\cancel{x-4}} & \text{usando que } x \neq 4 \\
    & = x-1.
  \end{align*}
\end{example}
%------------------------------------------------------------------------------%
...
\begin{example}
  ...
  \begin{align*}
    ...
    = \frac{(x+2)(x-6)}{x+2} \; \frac{2x+1}{x-6}       \\
    & = (x-6)
      \; \frac{2x+1}{x-6} & & \text{usando que } x \neq -2   \\
    & = 2x + 1.             & & \text{usando que } x \neq  6
  \end{align*}
\end{example}
%------------------------------------------------------------------------------%
