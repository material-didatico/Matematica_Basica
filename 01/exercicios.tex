...
\begin{enumerate}
    ...
    \item Para as sentenças a seguir, dê a recíproca e a contrapositiva das
      ...
      \begin{enumerate}
        ...
        \item Se $T$ é um triângulo équilátero então $T$ é um triângulo
          isósceles (Ou de modo equivalente : Todo triângulo equilátero é
          isósceles).
    ...
    \item A recíproca da proposição apresentada na questão anterior, item $e$ é
      verdadeira? Justifique.

    \item Demonstre, de duas maneiras diferentes, as seguintes proposições. Em
    ...
    \item Demonstre, usando redução ao absurdo, que $\sqrt{3}$ é um número
      irracional.

    \item Todas as proposições abaixo são falsas. Dê um contra-exemplo que
...
\begin{enumerate}
    ...
    \item Não. A recíproca afirma que se $x^2=1$ então $x=1$.
